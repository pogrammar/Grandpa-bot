...
class Help(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.pages = [
            discord.Embed(title="About", description="I am a bot made collaborative with <@503720029456695306>\nI am a grandad who is updated on the latest memes. I respond to dad bot and mom bot, and I also have some funcions of my own. See them by clicking the buttons!\n\n\n [Invite me!](https://discord.com/api/oauth2/authorize?client_id=957709454583947276&permissions=535260822592&scope=bot%20applications.commands) • [Discord server](https://discord.gg/RVMNP6TAGx) • [Github](https://github.com/pogrammar/Grandpa-bot)", color=discord.Color.random()),
